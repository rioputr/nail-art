...
@section('title', 'Login - Caroline Nail Art')

@section('content')
<div class="min-vh-100 d-flex">
    <!-- Left Side: Image/Illustration (Visible on Desktop) -->
    <div class="d-none d-lg-flex col-lg-6 align-items-center justify-content-center p-5 position-relative overflow-hidden" style="background-color: #fff5f8;">
        <!-- Decorative Elements -->
        <div class="position-absolute translate-middle" style="top: 10%; right: -5%; width: 300px; height: 300px; background: radial-gradient(circle, rgba(233, 30, 99, 0.1) 0%, transparent 70%); border-radius: 50%;"></div>
        <div class="position-absolute translate-middle" style="bottom: -10%; left: 0%; width: 400px; height: 400px; background: radial-gradient(circle, rgba(233, 30, 99, 0.05) 0%, transparent 70%); border-radius: 50%;"></div>
        ...
        <div class="text-center position-relative z-1 animate-fade-up">
            ...
            <h1 class="display-4 fw-bold text-primary-custom mb-3">Tunjukkan Kilau Anda</h1>
            <p class="lead text-muted mx-auto" style="max-width: 450px;">
                Masuk untuk menjelajahi koleksi terbaru dan pesan perawatan kuku premium Anda sekarang.
            </p>
        </div>
    </div>
    ...
    <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center bg-white p-4 p-md-5">
        <div class="w-100" style="max-width: 420px;">
            ...
            <a href="/" class="text-decoration-none text-muted mb-4 d-inline-block transition-hover">
                <button class="btn btn-primary-custom bi bi-arrow-left me-2"> Kembali ke Beranda</button>
            </a>
            ...
            <form method="POST" action="{{ route('login') }}" class="needs-validation">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('password.request') }}" class="text-primary-custom text-decoration-none small fw-semibold">
                            Lupa Kata Sandi?
                        </a>
                    </div>
                    <div class="input-group input-group-lg group-focus-pink">
                ...
                <div class="mb-4">
                    <div class="form-check custom-checkbox">
                        ...
                        <label class="form-check-label text-muted small" for="remember">
                            Tetap masuk untuk kunjungan berikutnya
                        </label>
                    </div>
                </div>
                ...
                <div class="row g-2 mb-4">
                    <div class="col-6">
                        <a href="#" class="btn btn-outline-light border text-dark w-100 py-2 rounded-3 d-flex align-items-center justify-content-center gap-2 transition-hover bg-white shadow-sm-hover">
                            <img src="https://www.gstatic.com/images/branding/product/1x/googleg_48dp.png" height="18"> <span class="small fw-semibold">Google</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="#" class="btn btn-outline-light border text-dark w-100 py-2 rounded-3 d-flex align-items-center justify-content-center gap-2 transition-hover bg-white shadow-sm-hover">
                            <i class="bi bi-facebook text-primary"></i> <span class="small fw-semibold">Facebook</span>
                        </a>
                    </div>
                </div> -->
                ...
                <div class="text-center">
                    <p class="text-muted small mb-0">
                        Belum memiliki akun? 
                        <a href="{{ route('register') }}" class="text-primary-custom fw-bold text-decoration-none ms-1">
                            Daftar Gratis
                        </a>
                    </p>
                </div>
